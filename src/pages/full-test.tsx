...
import { BottomsheetFull } from "../components/bottomsheet-full";
...
export const FullTest = () => {
  ...
  return (
    <>
      ...
      <BottomsheetFull active={open} close={() => setOpen(false)}>
        <div className="px-4">
        ...
        <div className="h-10 w-full bg-persimmon fixed bottom-0 z-50 flex items-center justify-center text-white">
          Click Me
        </div>
      </BottomsheetFull>
    </>
